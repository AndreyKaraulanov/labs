...
void Main::printList(Human** List, int size)
{
    ...
    cout << "\n --------------------------------------------------------------------------------------------------------------------------------\n";
    cout << "| N " << "|" << setw(15) << "Full Name" << setw(6) << "|" << setw(20) << "Contacts" << setw(14) << "|" << setw(13) << "Person" << setw(4) << "  |  " << setw(15) << "Additional information" << setw(3) << "  |  " << setw(11) << "Reason for visiting " << setw(5) << "  |";
    cout << "\n --------------------------------------------------------------------------------------------------------------------------------\n";
    for (size_t i = 0; i < size; i++) {
    ...
    for (size_t i = 0; i < size; i++) {
        ...
        else
        {
            if (Nrand == 1)
                ...
                NewList[i] = new Npatient;
            else if (Nrand == 4)
                NewList[i] = new Doctor;
            else if (Nrand == 5)
    ...
    for (size_t i = 0, j = 0; i < size;) {
        ...
        else
        {
            if (Nrand == 1)
                ...
                NewList[j] = new Npatient;
            else if (Nrand == 4)
                NewList[j] = new Doctor;
            else if (Nrand == 5)
